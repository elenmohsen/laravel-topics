    ...
    <div class="mx-2">
      ...
      <form action="{{route('topics.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="text" placeholder="e.g. Design Patterns" name="topicTitle" class="form-control py-2" value="{{old('topicTitle')}}"/>
            @error('topicTitle')
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <select name="category_id" id="" class="form-control py-1" value="{{old('category_id')}}">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="checkbox" class="form-check-input" name="trending" style="padding: 0.7rem;" value="1" @checked(old('trending')) />
            @error('trending')
              <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
